<template>
    ...
    <head>
        <title>Админ панель | Киім өзгерту</title>
    </head>
    <AdminLayout>
        <template #breadcrumbs>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Киім өзгерту</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Киім өзгерту</li>
                    </ol>
                </div>
            </div>
        </template>
                        ...
                        <div class="form-group file-upload">
                            ...
                            <div class="ml-2">
                                <div class="ml-2">
                                    ...
                                    <br>
                                    <img v-if="form.image && !image.file" :src="route('index')  +'/storage/files/images/odezhdalar/' +  form.image" height="300" alt="image" style="padding-bottom: 10px" />
...
<script>
    ...
    export default {
        ...
        props: ['colors', 'facturers', 'forms', 'types', 'form'],
        methods: {
            submit() {
                if(this.image.file ) this.form.image = this.image.file
                this.$inertia.put(
                    route("admin.odezhdalar.update", this.form.id),
                    this.form, {
