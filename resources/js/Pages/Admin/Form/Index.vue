<template>
    <head>
        <title>Админ панель | Форма түрлері</title>
    </head>
    <AdminLayout>
        <template #breadcrumbs>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Форма түрінің тізімі</h1>
                </div>
                <div class="col-sm-6">
...
export default {
    ...
    methods: {
        deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.$inertia.delete(route("admin.forms.destroy", id));
                }
            });
        ...
        search() {
            ...
            this.$inertia.get(route("admin.forms.index"), params);
        },
    },
};
</script>
