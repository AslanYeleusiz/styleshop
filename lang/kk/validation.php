...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'size_info.*' => [
            'required' => ':attribute өлшемін енгізіңіз'
        ],
        'type_id' => [
            'required' => ':attribute таңдаңыз'
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'brand' => 'Бренд',
        'facturer_id' => 'Өндіріс орнын',
        'color_id' => 'Түсті',
        'value' => 'Санын',
        'form_type_id' => 'Пішінін',
        'size_info.zhambas' => 'Жамбас',
        'size_info.bel' => 'Бел',
        'size_info.keude' => 'Кеуде',
        'type_id' => 'Киім түрін',
