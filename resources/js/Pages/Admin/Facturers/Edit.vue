<template>
   <head>
        <title>Админ панель | Өндірістік орын өзгерту</title>
    </head>
    <AdminLayout>
        <template #breadcrumbs>
              <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Өндірістік орын №{{ facturer.id }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Өндірістік орын №{{ facturer.id }}</li>
                    </ol>
                </div>
            </div>
        </template>
...
export default {
    ...
    methods: {
        submit() {
            this.$inertia.put(
                route("admin.facturers.update", this.facturer.id),
                this.facturer,
                {
