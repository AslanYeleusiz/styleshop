<template>
    <head>
        <title>Админ панель | Киім түстері</title>
    </head>
    <AdminLayout>
        <template #breadcrumbs>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Киім түстер тізімі</h1>
                </div>
                <div class="col-sm-6">
...
export default {
    ...
    methods: {
        deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.$inertia.delete(route("admin.colors.destroy", id));
                }
            });
        ...
        search() {
            ...
            this.$inertia.get(route("admin.colors.index"), params);
        },
    },
};
</script>
